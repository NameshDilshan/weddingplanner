...
class _LiquorPageState extends State<LiquorPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Liquor Menu", textAlign: TextAlign.center),
      ),
                ...
                child: TextFormField(
                  ...
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                      return 'Please enter Liquor Name';
                    }
                    return null;
                  },
                ),
