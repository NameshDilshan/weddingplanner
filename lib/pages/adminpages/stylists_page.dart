...
class _StylistsPageState extends State<StylistsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Stylists Menu", textAlign: TextAlign.center),
      ),
                ...
                child: TextFormField(
                  ...
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                      return 'Please enter Stylist Name';
                    }
                    return null;
                  },
                ),
      ...
      if (_formKey.currentState!.validate()) {
        FirebaseFirestore.instance.collection(collectionName).doc().set({
          ...
          'description': descriptionController.text
            ...
            MaterialPageRoute(builder: (context) => const StylistsPage())));
      }
    }
  }
}
